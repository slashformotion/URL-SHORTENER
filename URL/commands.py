...
@with_appcontext
def init():
    admin_role = models.Role(name="admin", description="Administrateur")
    classic_role = models.Role(name="classic", description="superawesome classic user")
...
def reset():
    ...
    for num in range(1, 5):
        ...
        for num in range(random.randint(20,250)):
